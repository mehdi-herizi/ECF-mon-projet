    ...
    <section class="p-4 md:p-12 min-h-screen">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
                ...
                <a href="?action=admin_messages" class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-full transition-all shadow-lg shadow-green-900/20">
                    Messages reçus
                </a>
                <a href="?action=add_product" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition-all shadow-lg shadow-blue-900/20">
            ...
            <form method="get" class="mb-8">
                ...
                <div class="flex items-center gap-2 bg-gray-800 border border-white/10 rounded-2xl px-4 py-3 shadow-xl focus-within:border-blue-500 transition-all max-w-xl">
                    ...
                    <?php if ($recherche !== ''): ?>
                        <a href="?action=admin" class="text-gray-500 hover:text-red-500 transition-colors text-xs font-black uppercase">✕</a>
                    <?php endif; ?>
                            ...
                            <tr class="hover:bg-white/5 transition-colors">
                                ...
                                <td class="p-4">
                                    <div class="flex justify-center gap-3">
                                        <a href="?action=edit_product&id=<?= $p['id_product'] ?>" class="p-2 bg-yellow-500/10 text-yellow-500 rounded-xl hover:bg-yellow-500 hover:text-black transition-all">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                        </a>
                                        <a href="?action=delete_product&id=<?= $p['id_product'] ?>" onclick="return confirm('Supprimer définitivement ce jeu ?')" class="p-2 bg-red-500/10 text-red-500 rounded-xl hover:bg-red-500 hover:text-white transition-all">
