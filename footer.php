...
<div class="flex gap-4">
    <a href="#" class="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-blue-600 hover:shadow-[0_0_15px_rgba(37,99,235,0.5)] transition-all border border-white/10 text-white font-black italic">X</a>
    <a href="#" class="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-blue-600 hover:shadow-[0_0_15px_rgba(37,99,235,0.5)] transition-all border border-white/10 text-white font-black italic">IG</a>
    <a href="#" class="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-blue-600 hover:shadow-[0_0_15px_rgba(37,99,235,0.5)] transition-all border border-white/10 text-white font-black italic">FB</a>
</div>
    <button 
        id="backToTop" 
        class="fixed bottom-8 right-8 z-[999] p-4 bg-blue-600/20 backdrop-blur-md border border-blue-500/50 text-blue-500 rounded-2xl shadow-[0_0_20px_rgba(37,99,235,0.3)] opacity-0 translate-y-10 invisible transition-all duration-500 hover:bg-blue-600 hover:text-white hover:shadow-[0_0_30px_rgba(37,99,235,0.6)] group"
        ...
        <div class="bg-black/80 backdrop-blur-xl border border-white/10 rounded-[40px] p-8 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="index.php" class="text-gray-400 text-xs hover:text-blue-500 transition-colors uppercase font-bold">Accueil</a></li>
                        <li><a href="catalogue.php" class="text-gray-400 text-xs hover:text-blue-500 transition-colors uppercase font-bold">Catalogue</a></li>
                        <li><a href="contact.php" class="text-gray-400 text-xs hover:text-blue-500 transition-colors uppercase font-bold">Assistance</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all border border-white/5 font-bold text-white flex items-center justify-center">X</a>
                        <a href="#" class="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all border border-white/5 font-bold text-white flex items-center justify-center">IG</a>
                        <a href="#" class="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all border border-white/5 font-bold text-white flex items-center justify-center">FB</a>
                    </div>
                </div>
            </div>
